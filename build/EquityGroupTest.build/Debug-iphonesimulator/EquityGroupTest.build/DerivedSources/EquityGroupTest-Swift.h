...
#ifndef EQUITYGROUPTEST_SWIFT_H
#define EQUITYGROUPTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EquityGroupTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15EquityGroupTest11AppDelegate")
...
SWIFT_CLASS("_TtC15EquityGroupTest24CoinDetailViewController")
...
SWIFT_CLASS("_TtC15EquityGroupTest22CoinListViewController")
...
@interface CoinListViewController (SWIFT_EXTENSION(EquityGroupTest)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15EquityGroupTest17CoinTableViewCell")
@interface CoinTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView_icon;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified label_name;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified label_24hrPerformance;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified label_currentPrice;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC15EquityGroupTest23FavoritesViewController")
...
@interface FavoritesViewController (SWIFT_EXTENSION(EquityGroupTest))
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
SWIFT_CLASS("_TtC15EquityGroupTest13SceneDelegate")
